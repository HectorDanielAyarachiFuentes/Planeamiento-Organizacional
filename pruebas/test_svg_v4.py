...
# Explicit width, height and viewBox for perfect pixel-to-pixel aspect ratio
...
test_svg_path = 'pruebas/RioNegro_improved_v4.svg'
tree.write(test_svg_path, encoding='utf-8', xml_declaration=True)

doc = pymupdf.open(test_svg_path)
page = doc[0]
pix = page.get_pixmap(dpi=150)
pix.save('pruebas/rionegro_improved_v4.png')
print('Generated rionegro_improved_v4.png successfully:', pix.width, 'x', pix.height)
